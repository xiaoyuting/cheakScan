...
-(void)layoutSubviews{
    ...
    _textField.frame = CGRectMake((CGRectGetHeight(self.frame)-lineWidth)+5, 0, CGRectGetWidth(self.frame)- (CGRectGetHeight(self.frame)-lineWidth)-5, CGRectGetHeight(self.frame)+0.5);
    ...
    _lineView.frame = CGRectMake((CGRectGetHeight(self.frame)-lineWidth)+5, CGRectGetHeight(self.frame)-lineWidth, CGRectGetWidth(self.frame)-(CGRectGetHeight(self.frame)-lineWidth)-5, lineWidth);
}
